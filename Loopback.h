//
// Created by Amaury Manzione on 12/11/2023.
//

#ifndef PROJET_LOOPBACK_H
#define PROJET_LOOPBACK_H
...
public:
     ...
     */
    Loopback(const BlackScholes& S, double T, double T0, int K, int N, int n);
